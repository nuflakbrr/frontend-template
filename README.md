## TanStack Start Template (Tailwind CSS, ESLint, Prettier)
...
Ini adalah proyek [TanStack Start](https://tanstack.com/start) yang di-bootstrap menggunakan [**BikinProject**](https://nuflakbrr.github.io/bikinproject).
...
- **Modern Stack**: Menggunakan versi terbaru dari TanStack Start dan React 19.
- **File-based Routing**: Menggunakan TanStack Router untuk manajemen rute yang type-safe.
- **Automated SEO**: Script otomatis untuk menghasilkan metadata SEO.
...
│  ● TanStack Start (Tailwind + TypeScript)
│  ○ dll.
